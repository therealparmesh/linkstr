...
4. Bring the app to the foreground and leave it open for a few seconds. linkstr rebuilds relay runtime from scratch on foreground and keeps retrying while no relay is healthy.
